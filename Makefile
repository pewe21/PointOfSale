...
db_up_1:
	migrate -database postgres://postgres@localhost:5432/pointOfSale?sslmode=disable -path internal/database/migration up 1

db_down:
	migrate -database postgres://postgres@localhost:5432/pointOfSale?sslmode=disable -path internal/database/migration down

db_down_1:
	migrate -database postgres://postgres@localhost:5432/pointOfSale?sslmode=disable -path internal/database/migration down 1
